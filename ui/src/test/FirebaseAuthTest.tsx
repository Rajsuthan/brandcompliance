      ...
      {user ? (
        <div className="mb-6">
          <div className="p-4 bg-zinc-800 rounded-md mb-4">
            <h2 className="text-lg font-semibold mb-2 text-white">Signed In User</h2>
          ...
          {token && (
            <div className="mb-4">
              <div className="p-4 bg-zinc-800 rounded-md mb-2">
                <h2 className="text-lg font-semibold mb-2 text-white">ID Token</h2>
          ...
          {verificationResult && (
            <div className="p-4 bg-zinc-800 rounded-md">
              <h2 className="text-lg font-semibold mb-2 text-white">Verification Result</h2>
